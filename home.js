...
const forms = [
  `<div class="form-card" onclick="goToforms()" style="cursor:pointer">
...
steps.forEach((step, index) => {
  step.addEventListener("click", () => {
    switch (index) {
      case 0:
        window.location.href = "buttons.html"; // Redirect for Buttons
        break;
      case 1:
        window.location.href = "cards.html"; // Redirect for Cards
        break;
      case 2:
        window.location.href = "forms.html"; // Redirect for Forms
        break;
      case 3:
        window.location.href = "systems.html"; // Redirect for Systems
        break;
    }
  });
});
